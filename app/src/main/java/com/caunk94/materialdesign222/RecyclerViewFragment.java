...
/**
 * Created by ilham-hp on 9/9/2015.
 */
...
public class RecyclerViewFragment extends Fragment {
    ...
    int[] icons={
            ...
            R.drawable.flat_2,
            R.drawable.flat_3};
    String[] judul={"Pria","Remaja","Wanita"};
    String[] deskripsi={"Deskripsi untuk pria.","Deskripsi untuk remaja.","Deskripsi untuk wanita."};
    //End of Recycle View
    ...
    private void initDataset() {
        ...
        mDataset3 = new int[icons.length];
