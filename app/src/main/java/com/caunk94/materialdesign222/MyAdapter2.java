...
/**
 * Created by caunk94 on 5/29/2016.
 */
...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.ViewHolder> {
    ...
    MyAdapter2(String Titles[],int Icons[],String Name,String Email, int Profile){ // MyAdapter Constructor with titles and icons parameter
